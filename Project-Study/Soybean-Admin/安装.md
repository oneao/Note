## 环境
- **git**: 你需要git来克隆和管理项目版本。[安装教程](https://docs.soybeanjs.cn/zh/tutorial/git.html)
- **NodeJS**: >=18.12.0，推荐 18.19.0 或更高。[安装教程](https://docs.soybeanjs.cn/zh/tutorial/nodejs.html)
- **pnpm**: >= 8.7.0，推荐最新版本。
