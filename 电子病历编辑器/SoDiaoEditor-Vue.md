...
```js
<template>  
  <div>    <div ref="editor" :style="{height: props.height, width: props.width}"  
...
onMounted(() => {  
  sde.value = new SDE({  
    ...
    print: {  
      ...
      printDirection: 'vertical', //打印方向 vertical|horizontal      printCssUrl: null, //打印的样式表，可以是string，也可以是array  
      ...
      items: [{  
        ...
        items: [{  
          ...
          render: function () {  
            ...
            <div class="sde-icon sde-icon-openxml" style="width: 40px; height: 32px; float: none;"></div>            <div style="text-align: center;">字符扩展</div>  
          </div>`;  
          }  
        }, {  
          name: 'tt2',  
          ...
          render: function () {  
            ...
            <div class="sde-icon sde-icon-openxml" style="width: 40px; height: 32px; float: none;"></div>            <div style="text-align: center;">对象扩展</div>  
          </div>`;  
